...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    /* Появление блоков запускаем сами. Раньше это делал скрипт каждой
       страницы — main.js, project.js, products.js, — и страница без
       своего скрипта показывала пустоту: блоки с классом rv остаются
       прозрачными, пока их никто не «проявит». Повторный вызов из
       страничных скриптов безопасен: reveal() отключает прежний
       наблюдатель и подписывается заново. */
    reveal();
  });
